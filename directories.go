...
func createDirectory(tr fdb.Transactor, parentDir directory.Directory, path ...string) (directory.DirectorySubspace, error) {
	dir, err := parentDir.CreateOrOpen(tr, path, nil)
	if err != nil {
